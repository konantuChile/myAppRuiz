...
class SupervisorsControllerTest < ActionController::TestCase
  ...
  test "should create supervisor" do
    assert_difference('Supervisor.count') do
      post :create, supervisor: { fechaingresoencargado: @supervisor.fechaingresoencargado, idempleado: @supervisor.idempleado }
    end
  ...
  test "should update supervisor" do
    patch :update, id: @supervisor, supervisor: { fechaingresoencargado: @supervisor.fechaingresoencargado, idempleado: @supervisor.idempleado }
    assert_redirected_to supervisor_path(assigns(:supervisor))
  end
